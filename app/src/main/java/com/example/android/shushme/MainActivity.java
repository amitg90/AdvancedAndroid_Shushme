...
public class MainActivity extends AppCompatActivity implements
    ...
    void refreshPlacesData() {
        ...
        while (cursor.moveToNext()) {
            list.add(cursor.getString(cursor.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID)));
        }

        final PendingResult<PlaceBuffer> placeResult = Places.GeoDataApi.getPlaceById(client, list.toArray(new String[list.size()]));
